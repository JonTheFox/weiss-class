...
const columns = [
	{ field: "v1", title: "V1" },
	{ field: "v2", title: "V2", subtitle: "Past Simple" },
	{ field: "v3", title: "V3", subtitle: "Passive & Perfect" },
];

let animationFrame;
const label = "VerbTable";
...
const VerbTable = React.forwardRef((props, ref) => {
	...
	return (
		<View
			className={clsx(
				"verb-table fullsize position--relative",
